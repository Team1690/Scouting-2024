                      ...
                      children: <Widget>[
                        ...
                        if (vars.climb) ...<Widget>[
                          PitToggle(
                            ...
                            titles: const <String>["Can Harmonize"],
                          ),
                          const SizedBox(
                            width: 10,
                          ),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        PitToggle(
                          ...
                          titles: const <String>["Can Pass Under Stage"],
                        ),
                        const SizedBox(
                          width: 20,
                        ),
