                          ...
                          ? ExpansionTile(
                                ...
                                ListTile(
                                  title: Row(
                                    children: <Widget>[
                                      Expanded(
                                        child: Text(
                                          "Tele Amp\n Average: ${autoPickListTeam.aggregateData.avgTeleAmp.toStringAsFixed(2)}",
                                          textAlign: TextAlign.center,
                                        ),
                                      ),
                                      Expanded(
                                        child: Text(
                                          "Tele Speaker\n Average: ${autoPickListTeam.aggregateData.avgTeleSpeaker.toStringAsFixed(2)}",
                                          textAlign: TextAlign.center,
                                        ),
                                      ),
                                      Expanded(
                                        child: Text(
                                          "Auto Amp\n Average: ${autoPickListTeam.aggregateData.avgAutoAmp.toStringAsFixed(2)}",
                                        ),
                                      ),
                                      Expanded(
                                        child: Text(
                                          "Auto Speaker\n Average: ${autoPickListTeam.aggregateData.avgAutoSpeaker.toStringAsFixed(2)}",
                                        ),
                                      ),
                                      Expanded(
                                        child: Text(
                                          "Trap Amount\n Average: ${autoPickListTeam.aggregateData.avgTrapAmount.toStringAsFixed(2)}",
                                        ),
                                      ),
                                    ],
                                  ),
                              ...
                              title: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Text(
                                      "Climbed: ${autoPickListTeam.climbedPercentage.toStringAsFixed(2)}%",
                                    ),
                                  ),
                                  Expanded(
                                    child: Text(
                                  ...
                                  Expanded(
                                    child: Text(
                                      "Matches: ${autoPickListTeam.amountOfMatches}",
                                    ),
                                  ),
                                ],
                              ),
