                  ...
                  children: <Widget>[
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        Text(
                          "Climb Percentage: ${data.climbPercentage.toStringAsFixed(1)}%",
                        ),
                        Text(
                          "Can Harmony: ${data.canHarmony ?? "No Data"}",
                        ),
                        Text("Matches Climbed 1: ${data.matchesClimbedSingle}"),
                        Text("Matches Climbed 2: ${data.matchesClimbedDouble}"),
                        Text("Matches Climbed 3: ${data.matchesClimbedTriple}"),
                      ],
                    ),
                    Column(
                      children: <Widget>[
